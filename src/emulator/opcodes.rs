...
impl OpWrapper {
    pub fn new(op: Opcode, addr_mode: AddrMode, cycle: u8, inst: Inst) -> Self {
        Self {
            op: op,
            inst: inst,
            addr_mode: addr_mode,
